...
public class AddressController {
    ...
    */
    @RequestMapping("/save")
    public Response save(@RequestBody AddressEntity address, HttpServletRequest request){
    ...
    */
    ...
    public Response update(@RequestBody AddressEntity address, HttpServletRequest request){
...
//                            addressEntity.setCreateTime(date);//时间
                        ...
                        if(addressEntities_addressPhone.size() >0 ){
                            ...
                            return Response.error(511,"数据库的该表中的 [电话] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    @RequestMapping("/add")
    public Response add(@RequestBody AddressEntity address, HttpServletRequest request){
